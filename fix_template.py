            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="default_order_status" class="form-select">
                        <option value="pending" {% ifequal config.default_order_status 'pending' %}selected{% endifequal %}>Pending</option>
                        <option value="confirmed" {% ifequal config.default_order_status 'confirmed' %}selected{% endifequal %}>Confirmed</option>
                        <option value="processing" {% ifequal config.default_order_status 'processing' %}selected{% endifequal %}>Processing</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
...
with open('techshop/templates/admin/website_settings.html', 'w', encoding='utf-8') as f:
    f.write(content)
